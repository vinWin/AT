...
pack.installNightmare = function (opts) {
    ...
    url = opts.electronPackageUrl || 'http://github.com/dimkir/nightmare-lambda-tutorial/releases/download/v0.5/nightmare-lambda-pck-with-xvfb-20170313-1726-43.zip';
